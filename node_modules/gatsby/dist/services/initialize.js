...
async function initialize({
  ...
  if (!oldPluginsHash || pluginsHash !== oldPluginsHash || cacheIsCorrupt) {
    try {
      ...
      `${cacheDirectory}/**`, `!${cacheDirectory}/data`, `${cacheDirectory}/data/**`, `!${cacheDirectory}/data/gatsby-core-utils/`, `!${cacheDirectory}/data/gatsby-core-utils/**`, `!${cacheDirectory}/compiled`];
