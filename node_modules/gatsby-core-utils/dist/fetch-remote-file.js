...
async function fetchFile({
  ...
  try {
    ...
    const finalDirectory = _path.default.join(fileDirectory, digest);
    ...
    let filename = (0, _filenameUtils.createFilePath)(_path.default.join(fileDirectory, digest), name, ext); // See if there's response headers for this url
    ...
    if (response.statusCode === 200) {
      ...
      const slashedDirectory = (0, _path2.slash)(fileDirectory);
