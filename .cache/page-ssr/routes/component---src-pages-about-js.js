...
;// CONCATENATED MODULE: ./src/components/section-header/index.js
function SectionHeader({title}){return/*#__PURE__*/index_js_default().createElement("div",{className:"section-header-wrapper"},/*#__PURE__*/index_js_default().createElement("div",{className:"section-header"},/*#__PURE__*/index_js_default().createElement("h2",null,title)));}/* harmony default export */ const section_header = (SectionHeader);
// EXTERNAL MODULE: ./src/components/icon-button-bar/index.js + 3 modules
var icon_button_bar = __webpack_require__(4473);
;// CONCATENATED MODULE: ./src/components/timestamp-section/index.js
function TimeStampSection({timestamps}){if(!timestamps||timestamps.length<2)return null;return/*#__PURE__*/index_js_default().createElement("div",{className:"timestamp-section"},/*#__PURE__*/index_js_default().createElement(section_header,{title:"Timestamps"}),/*#__PURE__*/index_js_default().createElement("div",{className:"body"},timestamps.map((timestamp,index)=>index===0?null:/*#__PURE__*/index_js_default().createElement("div",{className:"timestamp",key:index},/*#__PURE__*/index_js_default().createElement("div",{className:"date"},timestamp.date),/*#__PURE__*/index_js_default().createElement("div",{className:"activity"},timestamp.activity,"\xA0",timestamp.links&&/*#__PURE__*/index_js_default().createElement(icon_button_bar/* default */.Z,{links:timestamp.links}))))));}/* harmony default export */ const timestamp_section = (TimeStampSection);
// EXTERNAL MODULE: ./src/components/image/index.js + 1 modules
var components_image = __webpack_require__(9979);
;// CONCATENATED MODULE: ./src/components/project-section/index.js
function ProjectSection({projects}){if(!projects||projects.length<2)return null;return/*#__PURE__*/index_js_default().createElement("div",{className:"project-section"},/*#__PURE__*/index_js_default().createElement(section_header,{title:"Projects"}),projects.map((project,index)=>index===0?null:/*#__PURE__*/index_js_default().createElement("div",{className:"project",key:index},/*#__PURE__*/index_js_default().createElement("div",{className:"head"},project.title,"\xA0\xA0",project.links&&/*#__PURE__*/index_js_default().createElement(icon_button_bar/* default */.Z,{links:project.links,style:{color:'#a8a8a8',fontSize:24}})),/*#__PURE__*/index_js_default().createElement("div",{className:"body"},/*#__PURE__*/index_js_default().createElement(components_image/* default */.Z,{className:"thumbnail",src:project.thumbnailUrl}),project.techStack&&/*#__PURE__*/index_js_default().createElement("div",{className:"tech-stack"},project.techStack.map((tech,index)=>/*#__PURE__*/index_js_default().createElement("div",{key:index,className:"tech"},tech))),/*#__PURE__*/index_js_default().createElement("div",{className:"description"},project.description)))));}/* harmony default export */ const project_section = (ProjectSection);
;// CONCATENATED MODULE: ./src/pages/about.js
function AboutPage({data}){const metaData=data.site.siteMetadata;const{author,about,language}=metaData;const{timestamps,projects}=about;return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"About"}),/*#__PURE__*/index_js_default().createElement(bio/* default */.Z,{author:author,language:language}),/*#__PURE__*/index_js_default().createElement(timestamp_section,{timestamps:timestamps}),/*#__PURE__*/index_js_default().createElement(project_section,{projects:projects}));}/* harmony default export */ const about = (AboutPage);const pageQuery="1206920106";
