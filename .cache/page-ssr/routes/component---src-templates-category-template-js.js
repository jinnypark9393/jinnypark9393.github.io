...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ category_template)
});
...
// EXTERNAL MODULE: ./src/models/post.js
var post = __webpack_require__(6132);
;// CONCATENATED MODULE: ./src/components/category-page-header/index.js
function CategoryPageHeader({title,subtitle}){return/*#__PURE__*/index_js_default().createElement("div",{className:"category-page-header-wrapper"},/*#__PURE__*/index_js_default().createElement("div",{className:"category-page-title"},title),/*#__PURE__*/index_js_default().createElement("div",{className:"category-page-subtitle"},subtitle));}/* harmony default export */ const category_page_header = (CategoryPageHeader);
// EXTERNAL MODULE: ./src/components/post-tabs/index.js + 16 modules
var post_tabs = __webpack_require__(3560);
;// CONCATENATED MODULE: ./src/templates/category-template.js
function CategoryTemplate({pageContext}){const{edges,currentCategory}=pageContext;const{categories}=pageContext;const currentTabIndex=(0,index_js_.useMemo)(()=>categories.findIndex(category=>category===currentCategory),[categories,currentCategory]);const posts=edges.map(({node})=>new post/* default */.Z(node));const onTabIndexChange=(0,index_js_.useCallback)((e,value)=>{if(value===0)return (0,gatsby_browser_entry.navigate)(`/posts`);(0,gatsby_browser_entry.navigate)(`/posts/${categories[value]}`);},[categories]);return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Posts"}),/*#__PURE__*/index_js_default().createElement(category_page_header,{title:categories[currentTabIndex],subtitle:`${posts.length} posts`}),/*#__PURE__*/index_js_default().createElement(post_tabs/* default */.Z,{tabIndex:currentTabIndex,onChange:onTabIndexChange,tabs:categories,posts:posts}));}/* harmony default export */ const category_template = (CategoryTemplate);
