...
var React = _interopRequireWildcard(__webpack_require__(6561));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6561);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_rotating_text__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1318);
...
/* harmony import */ var _icon_button_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4473);
/* harmony import */ var _image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9979);
function Bio({author,language='ko'}){if(!author)return null;const{bio,social,name}=author;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"bio"},language==='ko'?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"introduction korean"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"title"},"\uC548\uB155\uD558\uC138\uC694.",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_rotating_text__WEBPACK_IMPORTED_MODULE_1___default()),{items:bio.description}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),bio.role," ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong",null,name),"\uC785\uB2C8\uB2E4.",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"social-links"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_icon_button_bar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,{links:social}))):/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"introduction english"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"title"},"Hello,",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),"my name is",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong",null,name),".",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"description"},"I'm a ",bio.role," ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_rotating_text__WEBPACK_IMPORTED_MODULE_1___default()),{items:bio.description}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"social-links"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_icon_button_bar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,{links:social}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"thumbnail-wrapper"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_image__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,{style:{width:250,height:250},src:bio.thumbnail,alt:"thumbnail"})));}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Bio);
...
;// CONCATENATED MODULE: ./node_modules/@mui/core/utils/appendOwnerState.js
...
const Tooltip = /*#__PURE__*/index_js_.forwardRef(function Tooltip(inProps, ref) {
  ...
  const handleUseRef = (0,useForkRef/* default */.Z)(setChildNode, ref);
  const handleFocusRef = (0,useForkRef/* default */.Z)(focusVisibleRef, handleUseRef);
  const handleRef = (0,useForkRef/* default */.Z)(children.ref, handleFocusRef); // There is no point in displaying an empty tooltip.
...
var Description = __webpack_require__(1379);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/PlayArrowOutlined.js
var PlayArrowOutlined = __webpack_require__(2851);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/GitHub.js
var GitHub = __webpack_require__(5449);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/Android.js
var Android = __webpack_require__(9507);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/Apple.js
var Apple = __webpack_require__(4721);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/LinkedIn.js
var LinkedIn = __webpack_require__(8005);
;// CONCATENATED MODULE: ./src/components/icon-button-bar/index.js
function IconButtonBar({links={}}){const IconPicker=(0,index_js_.useCallback)(icon=>{const props={className:'icon'};switch(icon){case'post':return/*#__PURE__*/index_js_default().createElement(Description/* default */.Z,props);case'demo':return/*#__PURE__*/index_js_default().createElement(PlayArrowOutlined/* default */.Z,props);case'github':return/*#__PURE__*/index_js_default().createElement(GitHub/* default */.Z,props);case'googlePlay':return/*#__PURE__*/index_js_default().createElement(Android/* default */.Z,props);case'appStore':return/*#__PURE__*/index_js_default().createElement(Apple/* default */.Z,props);case'email':return/*#__PURE__*/index_js_default().createElement(Email/* default */.Z,props);case'linkedIn':return/*#__PURE__*/index_js_default().createElement(LinkedIn/* default */.Z,props);default:return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null);}},[]);return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,Object.keys(links).map((link,index)=>{return links[link]&&/*#__PURE__*/index_js_default().createElement(Tooltip_Tooltip,{key:index,title:link,arrow:true,className:"icon-tooltip"},/*#__PURE__*/index_js_default().createElement(IconButton/* default */.Z,{size:"small",href:`${link==='email'?`mailto:`:``}${links[link]}`},IconPicker(link)));}));}/* harmony default export */ const icon_button_bar = (IconButtonBar);
...
const image_Image=({src,...rest})=>{const data=(0,gatsby_browser_entry.useStaticQuery)("3350743975");const match=(0,index_js_.useMemo)(()=>data.images.edges.find(({node})=>src===node.relativePath),[data,src]);if(!match)return null;const{node:{childImageSharp,publicURL,extension}={}}=match;if(extension==='svg'||!childImageSharp){return/*#__PURE__*/index_js_default().createElement("img",Object.assign({src:publicURL,alt:publicURL},rest));}return/*#__PURE__*/index_js_default().createElement(Y,Object.assign({image:childImageSharp.gatsbyImageData,alt:publicURL},rest));};/* harmony default export */ const components_image = (image_Image);
...
const Tabs = /*#__PURE__*/index_js_.forwardRef(function Tabs(inProps, ref) {
  ...
  const [displayScroll, setDisplayScroll] = index_js_.useState({
    start: false,
    end: false
  });
  ...
  const handleTabsScroll = index_js_.useMemo(() => (0,debounce/* default */.Z)(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  index_js_.useEffect(() => {
    return () => {
...
const Button_excluded = ["children", "className", "color", "component", "disabled", "disableElevation", "disableFocusRipple", "disableRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"];
...
const Button = /*#__PURE__*/index_js_.forwardRef(function Button(inProps, ref) {
  ...
  } = index_js_.useContext(ButtonGroup_ButtonGroupContext);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(ButtonRoot, (0,esm_extends/* default */.Z)({
    ownerState: ownerState,
    className: (0,clsx_m/* default */.Z)(className, classNameContext),
    component: component,
    disabled: disabled,
...
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 4 modules
var gatsby_browser_entry = __webpack_require__(4688);
;// CONCATENATED MODULE: ./src/components/post-card/index.js
function PostCard({post}){const{id,slug,title,excerpt,date,categories}=post;return/*#__PURE__*/index_js_default().createElement("div",{className:"post-card-wrapper"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"post-card",key:id,to:slug},/*#__PURE__*/index_js_default().createElement("div",{className:"title"},title),/*#__PURE__*/index_js_default().createElement("p",{className:"description",dangerouslySetInnerHTML:{__html:excerpt}}),/*#__PURE__*/index_js_default().createElement("div",{className:"info"},/*#__PURE__*/index_js_default().createElement("div",{className:"date"},date),/*#__PURE__*/index_js_default().createElement("div",{className:"categories"},categories.map(category=>/*#__PURE__*/index_js_default().createElement("div",{className:"category",key:category},category))))));}/* harmony default export */ const post_card = (PostCard);
;// CONCATENATED MODULE: ./src/components/post-card-column/index.js
function PostCardColumn({posts,showMoreButton,moreUrl}){const onMoreButtonClick=(0,index_js_.useCallback)(()=>{(0,gatsby_link.navigate)(moreUrl);},[moreUrl]);return/*#__PURE__*/index_js_default().createElement("div",{className:"post-card-column-wrapper"},/*#__PURE__*/index_js_default().createElement("div",{className:"post-card-column"},posts.map((post,index)=>/*#__PURE__*/index_js_default().createElement(post_card,{key:index,post:post})),showMoreButton&&/*#__PURE__*/index_js_default().createElement(Button_Button,{className:"more-post-card-button",onClick:onMoreButtonClick,variant:"contained",disableElevation:true},"More")));}/* harmony default export */ const post_card_column = (PostCardColumn);
;// CONCATENATED MODULE: ./src/components/post-tabs/index.js
function PostTabs({tabIndex,onChange,tabs,posts,showMoreButton}){const tabPosts=(0,index_js_.useMemo)(()=>{if(tabs[tabIndex]==='All')return posts;return posts.filter(post=>post.categories.includes(tabs[tabIndex]));},[posts,tabs,tabIndex]);return/*#__PURE__*/index_js_default().createElement("div",{className:"post-tabs-wrapper"},/*#__PURE__*/index_js_default().createElement("div",{className:"post-tabs"},/*#__PURE__*/index_js_default().createElement(Tabs_Tabs,{className:"mui-tabs",value:tabIndex,onChange:onChange,variant:"scrollable",scrollButtons:"desktop"},tabs.map((title,index)=>/*#__PURE__*/index_js_default().createElement(Tab_Tab,{label:title,key:index})))),/*#__PURE__*/index_js_default().createElement(post_card_column,{posts:showMoreButton?tabPosts.slice(0,4):tabPosts,showMoreButton:showMoreButton&&tabPosts.length>4,moreUrl:`posts/${tabIndex===0?'':tabs[tabIndex]}`}));}/* harmony default export */ const post_tabs = (PostTabs);
...
// EXTERNAL MODULE: ./src/components/bio/index.js
var bio = __webpack_require__(2912);
// EXTERNAL MODULE: ./src/models/post.js
var post = __webpack_require__(6132);
;// CONCATENATED MODULE: ./src/utils/helpers.js
const getUniqueCategories=posts=>{const categorySet=new Set();posts.forEach(({categories})=>categories.forEach(category=>categorySet.add(category)));return[...categorySet].sort((a,b)=>{if(a==='featured')return-1;if(b==='featured')return 1;return 0;});};
// EXTERNAL MODULE: ./src/components/post-tabs/index.js + 16 modules
var post_tabs = __webpack_require__(3560);
;// CONCATENATED MODULE: ./src/pages/index.js
function HomePage({data}){const posts=data.allMarkdownRemark.edges.map(({node})=>new post/* default */.Z(node));const{author,language}=data.site.siteMetadata;const categories=['All',...getUniqueCategories(posts)];const featuredTabIndex=categories.findIndex(category=>category==='featured');const{0:tabIndex,1:setTabIndex}=(0,index_js_.useState)(featuredTabIndex===-1?0:featuredTabIndex);const onTabIndexChange=(0,index_js_.useCallback)((e,value)=>setTabIndex(value),[]);return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Home"}),/*#__PURE__*/index_js_default().createElement(bio/* default */.Z,{author:author,language:language}),/*#__PURE__*/index_js_default().createElement(post_tabs/* default */.Z,{posts:posts,onChange:onTabIndexChange,tabs:categories,tabIndex:tabIndex,showMoreButton:true}));}/* harmony default export */ const pages = (HomePage);const pageQuery="2043027757";
...
var React = __webpack_require__(6561);
var PropTypes = __webpack_require__(5697);
var toArray = __webpack_require__(3969);
